...
export function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className="flex min-h-screen">
      {/* Left panel — branding */}
      <div className="hidden w-[360px] flex-shrink-0 flex-col justify-between bg-[#0d1a26] p-10 text-white lg:flex xl:w-[400px]">
        {/* Logo */}
        <div>
          ...
          <h2 className="mb-4 text-[26px] font-bold leading-snug text-white">
          ...
          <div className="space-y-5">
            <div className="flex items-baseline gap-3">
              <span className="text-2xl font-bold text-[#0d9488]">10x</span>
              <span className="text-sm text-slate-400">
                Faster CV screening
              </span>
            </div>
            <div className="flex items-baseline gap-3">
              <span className="text-2xl font-bold text-[#0d9488]">95%</span>
              <span className="text-sm text-slate-400">Parsing accuracy</span>
            </div>
            <div className="flex items-baseline gap-3">
              <span className="text-2xl font-bold text-[#0d9488]">3M+</span>
